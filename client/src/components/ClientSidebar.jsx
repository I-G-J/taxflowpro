...
import { Menu, X, LayoutDashboard, Upload, FileText, CreditCard, MessageSquare, User, LogOut } from 'lucide-react';
...
const ClientSidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: Upload, label: 'Upload Documents', path: '/dashboard/upload' },
    { icon: FileText, label: 'Filing History', path: '/dashboard/filing-history' },
    { icon: CreditCard, label: 'Invoice & Billing', path: '/dashboard/billing' },
    { icon: MessageSquare, label: 'Chat Support', path: '/dashboard/chat' },
    { icon: User, label: 'Profile & KYC', path: '/dashboard/profile' },
  ];
